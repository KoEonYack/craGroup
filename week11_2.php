...
<body>
    ...
    <div class="container">
        <br>
        <p> 본 사이트에 첨부된 사진은 13학번 강민수 학생이 17-2 파이썬 TA세션을 진행하기 위해 제작한 PPT의 일부를 가져왔습니다.</p>
        <br>
        <a href="week11_2.html"><img alt="강민수" width="80%" height="80%"  src="https://t1.daumcdn.net/cfile/tistory/9915CC365BDD1EB80A" /></a>
        <br><br><br>
